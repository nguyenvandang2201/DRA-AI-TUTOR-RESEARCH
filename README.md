...
├── tools/      # Công cụ kiểm định, thống kê, split, baseline
├── tests/      # Kiểm thử toàn vẹn dữ liệu và tính tái lập
└── docs/       # Tài liệu mô tả dữ liệu, quy trình và kết quả
```
...
| `python tools/baseline_router.py --report` | Sinh `docs/baseline_results.md` |
...
**CC BY 4.0** và yêu cầu ghi công OpenStax khi phát tán lại. Xem mục nguồn gốc
trong [docs/dataset_card.md](docs/dataset_card.md).

## Trích dẫn

Xem [CITATION.cff](CITATION.cff).
